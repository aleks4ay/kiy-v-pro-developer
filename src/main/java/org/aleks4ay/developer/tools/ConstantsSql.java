...
public final class ConstantsSql {
    ...
    public static final String GET_ALL_FROM_OLD_DB = "select * from order_view where t_create > '2021-01-01T00:00:00';";
...
//    public static final String DESCRIPTION_TIME_CREATE_FROM_OLD = "insert into description_time (id_description, status, time) " +
//            "select ?, ?, ? where not exists (select * from description_time where id_description = ? and status = ?);";
